# update-stadiumsense-v2.ps1
# Run this from inside your stadiumsense project folder (where package.json lives).
# Deepens Ops mode: capacity trend history, urgency ranking, interactive incident
# status tracking. Plus the earlier Transportation/Sustainability additions.

Write-Host "Updating StadiumSense files (v2)..." -ForegroundColor Cyan
...
'@
Set-Content -Path "lib/mockData.ts" -Value $content -Encoding utf8 -NoNewline
...
'@
Set-Content -Path "lib/contextEngine.ts" -Value $content -Encoding utf8 -NoNewline
...
'@
Set-Content -Path "components/TransportPanel.tsx" -Value $content -Encoding utf8 -NoNewline
...
'@
Set-Content -Path "components/IncidentBoard.tsx" -Value $content -Encoding utf8 -NoNewline
...
'@
Set-Content -Path "app/fan/page.tsx" -Value $content -Encoding utf8 -NoNewline
...
'@
Set-Content -Path "app/ops/page.tsx" -Value $content -Encoding utf8 -NoNewline
...
'@
Set-Content -Path "tests/contextEngine.test.ts" -Value $content -Encoding utf8 -NoNewline
...
'@
Set-Content -Path "tests/mockData.test.ts" -Value $content -Encoding utf8 -NoNewline
...
'@
Set-Content -Path "tests/accessibility.test.tsx" -Value $content -Encoding utf8 -NoNewline
